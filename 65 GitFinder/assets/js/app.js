...
let /** {string} */ apiUrl = "https://api.github.com/users/mohdsultan18";
    ...
    fetchData(profileUrl, data => {
        ...
        ${twitter_username ?
             `<li class="meta-item">
                 <span class="icon">
                     <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://twitter.com/${twitter_username}" target="_blank" class="meta-text">@${twitter_username}</span>
                </li>` : ""
        }
             ...
             <ul class="profile-stats">
                ...
                <div class="footer">
                    <p class="copyright">&copy; 2023 mohdsultan18</p>
                </div>
        `;
            ...
            for (const item of data) {
                ...
                $followerCard.innerHTML = `
                    <figure class="avatar-circle img-holder">
                            <img src="${avatar_url}&s=64" width="56" height="56" loading="johndoe" alt="${username}" 
                            class="img-cover">
                    </figure>
